...
#  |                                                                                                 |
#  |  ```sh                                                                                          |
#  |  curl -sfS https://dotenvx.sh/vlt > install.sh                                                  |
#  |  chmod +x install.sh                                                                            |
#  |  ./install.sh                                                                                   |
#  |  ```                                                                                            |
#  |                                                                                                 |
...
#  |  ```sh                                                                                          |
#  |  # curl examples                                                                                |
#  |  curl -sfS "https://dotenvx.sh/vlt" | sudo sh                                                   |
#  |  curl -sfS "https://dotenvx.sh/vlt?version=0.44.5" | sh                                         |
#  |  curl -sfS "https://dotenvx.sh/vlt?directory=." | sh                                            |
#  |  curl -sfS "https://dotenvx.sh/vlt?directory=/custom/path&version=0.44.5" | sh                  |
#  |                                                                                                 |
